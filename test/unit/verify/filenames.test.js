...
const PENDING_GENESIS_CTL_BATCH_BLOB_NAME = 'PENDING_TEST_BATCH.ctl'

const PROCESSED_GENESIS_BATCH_BLOB_NAME = 'TEST_BATCH.gne'
const PROCESSED_GENESIS_CTL_BATCH_BLOB_NAME = 'TEST_BATCH.ctl'
...
const PENDING_DPS_BATCH_BLOB_NAME = 'PENDING_TEST_BATCH.OUT'
const PENDING_DPS_CTL_BATCH_BLOB_NAME = 'CTL_PENDING_TEST_BATCH.OUT'

const PROCESSED_DPS_BATCH_BLOB_NAME = 'TEST_BATCH.OUT'
const PROCESSED_DPS_CTL_BATCH_BLOB_NAME = 'CTL_TEST_BATCH.OUT'
